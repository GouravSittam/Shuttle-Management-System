...
export const JellyRadio: React.FC<JellyRadioProps> = ({
  ...
  return (
    <div
      ...
      className={`group jelly-radio-group inline-flex items-center select-none [-webkit-touch-callout:none] gap-[var(--jr-gap)] px-[var(--jr-pad-x)] py-[var(--jr-pad-y)] data-[disabled]:pointer-events-none data-[disabled]:opacity-50${className ? ` ${className}` : ''}`}
      style={
        {
          '--jr-chip': chipColor,
