...
import { X, Bus, MapPin, Phone, Star, LogIn, UserX, Ban, Edit3, CheckCircle2, Clock } from 'lucide-react';
        ...
        <div className="drawer-content">
          ...
          <div className="passenger-summary-box">
            <div>
              ...
              <div style={{ fontSize: '0.78rem', color: 'var(--text-secondary)', marginTop: '6px' }}>
                Sign In: <strong style={{ color: 'var(--text-primary)' }}>{booking.date}</strong>
              </div>
            </div>
              ...
              <div className="timeline-stop-node">
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  ...
                  {booking.delayMinutes > 0 && (
                    ...
                    >
                      <Clock size={12} />
                      <span>{booking.pickupTime} (+{booking.delayMinutes})</span>
                    </div>
                  )}
                </div>
              </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            <button
              ...
              onClick={() => onUpdateStatus(booking.id, 'Accepted', 'Rider signed in')}
            >
              <LogIn size={16} />
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <button
                ...
                onClick={() => onUpdateStatus(booking.id, 'Cancelled', 'Cancelled by admin')}
              >
                <Ban size={15} />
          ...
          <div style={{ borderTop: '1px solid var(--border-light)', paddingTop: '16px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <label htmlFor="notes-textarea" style={{ fontSize: '0.8rem', fontWeight: 700, color: 'var(--text-secondary)' }}>
